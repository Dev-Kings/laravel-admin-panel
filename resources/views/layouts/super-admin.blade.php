            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        ...
                        <i class="fa fa-angle-double-right" style="font-size: 1.0rem;"></i><span> Manage Data</span>
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-700">
                            <x-super-admin-link :href="route('super-admin.data.index')"
                                :active="request()->routeIs('super-admin.data.index')">
                            ...
                            <x-super-admin-link :href="route('super-admin.payments.index')"
                                :active="request()->routeIs('super-admin.payments.index')">
                                <div class="inline-flex space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <x-super-admin-link :href="route('super-admin.employees.alpha')"
                                :active="request()->routeIs('super-admin.employees.alpha')">
                                <div class="inline-flex space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <x-super-admin-link :href="route('super-admin.companies.index')"
                    :active="request()->routeIs('super-admin.companies.index')">
                    <div class="inline-flex space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <x-super-admin-link :href="route('super-admin.departments.index')"
                    :active="request()->routeIs('super-admin.departments.index')">
                    <div class="inline-flex space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <x-super-admin-link :href="route('super-admin.variables.index')"
                    :active="request()->routeIs('super-admin.variables.index')">
                    <div class="inline-flex space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <x-super-admin-link :href="route('super-admin.rates.data')"
                    :active="request()->routeIs('super-admin.rates.data')">
                    <div class="inline-flex space-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    <button @click="open = !open"
                        class="flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent text-gray-900 rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:block hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                        <i class="fa fa-bar-chart" style="font-size: 1.0rem;"></i><span> Graphs</span>
                        <svg fill="currentColor" viewBox="0 0 20 20" :class="{'rotate-180': open, 'rotate-0': !open}"
                            class="inline w-4 h-4 mt-1 ml-1 transition-transform duration-200 transform md:-mt-1">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100"
                        ...
                        class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg">
                        <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-700">
                            <x-super-admin-link :href="route('super-admin.monthly.payments.chart')"
                                :active="request()->routeIs('super-admin.monthly.payments.chart')">
                                <div class="inline-flex space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <div>Monthly Graph</div>
                                </div>
                            </x-super-admin-link>
                            <x-super-admin-link :href="route('super-admin.yearly.payments.chart')"
                                :active="request()->routeIs('super-admin.yearly.payments.chart')">
                                <div class="inline-flex space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-people" viewBox="0 0 16 16">
                                        <path
